...
class RobotV2:
    ...
    def help(self) -> dict[str, list[str]]:
        return {
            ...
            "display": ["text", "line", "number", "clear_matrix", "shape", "eyes", "look_left", "look_right", "look_up", "look_down", "wink", "left_wink", "center_wink", "right_wink", "blink", "sleep", "shut_eyes", "wake_up", "sleepy_blink", "close_left_eye", "close_center_eye", "close_right_eye", "open_left_eye", "open_center_eye", "open_right_eye", "smile", "triangle", "square", "diamond"],
