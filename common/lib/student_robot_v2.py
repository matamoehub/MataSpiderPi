...
class RobotV2:
    ...
    def help(self) -> dict[str, list[str]]:
        return {
            ...
            "display": ["text", "line", "number", "clear_matrix", "shape", "eyes", "look_left", "look_right", "look_up", "look_down", "wink", "blink", "sleep", "shut_eyes", "wake_up", "sleepy_blink", "smile", "triangle", "square", "diamond"],
