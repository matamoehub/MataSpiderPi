#!/usr/bin/python3
# coding=utf8
#第9章 机械臂正逆运动学课程\2.机械臂正逆运动学实战应用\第4课 机械臂底盘联动(9.Forward & Inverse Kinematic/2.Forward & Inverse Kinematics Practical Application\Lesson 4 Synchronized Adjustment)
import time
import copy
...
# 机械臂机体联动(synchronized adjustment)
