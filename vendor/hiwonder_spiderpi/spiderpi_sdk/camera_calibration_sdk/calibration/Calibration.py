...
#开始标定, 按任意键关闭最后的图像显示(start calibration and press any key to close the final image display)
...
#获取内外参(get the intrinsic and extrinsic parameters)
...
#读取第10张图片测试矫正(read the 10th image and test the calibration)
