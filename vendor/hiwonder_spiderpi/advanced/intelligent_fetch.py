#!/usr/bin/python3
# coding=utf8
#第6章 A视觉进阶课程\3.进阶课程之智能取物玩法课程\第2课 智能取物(6.AI Vision Advanced Lesson\3.Intelligent Picking\Lesson 2 Intelligent Picking)
import sys
import cv2
import math
import time
...
# 自定义人脸识别方法，最小的人脸检测置信度0.5(custom face recognition method with a minimum detection confidence of 0.5)
...
def load_config():
    ...
    print(yaml_handle.camera_file_path)
