...
def getAreaMaxContour(contours):
    ...
    for c in contours:  # 历遍所有轮廓(traverse through all contours)
        ...
        if contour_area_temp > contour_area_max:
            ...
            if contour_area_temp > 10:  # 只有在面积大于10时，最大面积的轮廓才是有效的，以过滤干扰(Only when the area is greater than 10, the contour with the maximum area is considered valid to filter out interference)
                area_max_contour = c
