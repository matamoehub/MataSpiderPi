...
FUNCTIONS = {
    1: RemoteControl, # 机体控制(robot control)
    2: ColorDetect,   # 颜色识别(color recognition)
    3: ColorTrack,    # 云台跟踪(pan-tilt tracking)
    4: VisualPatrol,  # 智能巡线 (line following)
    5: FaceDetect,    # 人脸识别(face recognition)
    6: ApriltagDetect,# 标签识别(tag recognition)
    7: Avoidance,     # 自动避障(obstacle avoidance)
    9: lab_adjust
}
